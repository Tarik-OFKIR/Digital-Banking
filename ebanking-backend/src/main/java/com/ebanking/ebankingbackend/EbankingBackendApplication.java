package com.ebanking.ebankingbackend;

import com.ebanking.ebankingbackend.dtos.BankAccountDTO;
...
import com.ebanking.ebankingbackend.repositories.AccountOperationRepository;
import com.ebanking.ebankingbackend.repositories.BankAccountRepository;
import com.ebanking.ebankingbackend.repositories.CustomerRepository;
import com.ebanking.ebankingbackend.services.BankAccountService;
...
public class EbankingBackendApplication {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService){
        return args -> {
            Stream.of("Tarik","Akram","Mohamed").forEach(name->{
    ...
    CommandLineRunner start(CustomerRepository customerRepository,
        ...
        return args -> {
            Stream.of("Saad","Yassine","Anas").forEach(name->{
            ...
            bankAccountRepository.findAll().forEach(acc->{
                for (int i = 0; i <10 ; i++) {
                    ...
                    accountOperation.setAccountMount(Math.random()*12000);
