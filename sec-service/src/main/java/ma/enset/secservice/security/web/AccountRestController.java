...
import ma.enset.secservice.security.dtos.AuthRequest;
...
@GetMapping("/login")
public void login(@RequestBody AuthRequest authRequest) throws Exception {
    this.accountService.login(authRequest.getUsername(),authRequest.getPassword());
}
